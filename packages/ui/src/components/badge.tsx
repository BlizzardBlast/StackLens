...
const badgeVariants = cva(
  "inline-flex w-fit items-center gap-1 rounded-full border px-2 py-1 text-xs font-semibold leading-none",
  {
    variants: {
      variant: {
        ...
        heuristic:
          "border-evidence-heuristic/35 bg-evidence-heuristic/10 text-evidence-heuristic",
        recommendation:
